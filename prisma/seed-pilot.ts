...
const TASKS: PilotTask[] = [
  ...
  { ref: "514", type: "Доставка / забор из аренды", title: "Доставка станка", address: "Москва, Косинское шоссе, 17",
  ...
  { ref: "520a", type: "Доставка / забор из аренды", title: "Доставка 2 шт. Тапко 2,2 м + 1 нож",
  ...
  { ref: "521", type: "Доставка / забор из аренды", title: "Доставка в аренду ЛБМ 250 + нож + дог.маш, 0,55 мм",
  ...
  { ref: "501", type: "Доставка / забор из ремонта", title: "Доставка ножа Ван Марк с ремонта",
  ...
  { ref: "526", type: "Доставка проданного об.", title: "Доставка нового Sorex 2 м + нож, забор трейд-ин Tapco Max 3,2 м",
  ...
  { ref: "529", type: "Сдача / забор из ТК", title: "Забрать груз (Желдорэкспедиция)",
  ...
  { ref: "530", type: "Доставка / забор из аренды", title: "Доставка ЛБМ 300 + нож + дог.маш, 0,7 мм",
